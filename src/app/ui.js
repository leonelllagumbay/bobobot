 ...
 */
export function logToStatusDisplay(message, statusDisplay) {
 ...
 */
export function populateCandidateWords(words, candidateWordsContainerArg) {
  candidateWordsContainer = candidateWordsContainerArg;
  candidateWordSpans = {};
